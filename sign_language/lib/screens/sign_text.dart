...
import 'package:sign_language/helpers/app_helper.dart';
import 'package:sign_language/helpers/camera_helper.dart';
import 'package:sign_language/helpers/tflite_helper.dart';
import 'package:sign_language/models/result.dart';

class Sign_Text extends StatefulWidget {
  Sign_Text({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Sign_TextState createState() => _Sign_TextState();
}

class _Sign_TextState extends State<Sign_Text>
  ...
  void _setupAnimation() {
    ...
    _colorTween = ColorTween(begin: Colors.orange, end: Colors.deepPurple)
